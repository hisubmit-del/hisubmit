using HiSubmit.Application.Features.ExtendedAttributes.Commands.AddEdit;
using HiSubmit.Application.Features.ExtendedAttributes.Commands.Delete;
using HiSubmit.Application.Features.ExtendedAttributes.Queries.Export;
using HiSubmit.Application.Features.ExtendedAttributes.Queries.GetAll;
...
namespace HiSubmit.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
