...
namespace Hisubmit.Client.SharedModels.Validators.Requests.Identity
{
    public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
    {
        public RegisterRequestValidator(IStringLocalizer<RegisterRequestValidator> localizer)
        {
            ...
            RuleFor(request => request.FestivalName)
                .Must((request,festivalName) => FestivalNameMustBeNotNull(request)).WithMessage(localizer["Name Must not be null"]);
        ...
        private  bool FestivalNameMustBeNotNull(RegisterRequest request)
        {
