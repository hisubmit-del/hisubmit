...
namespace HiSubmit.Infrastructure.Services.Storage.Provider
{
    internal class ServerStorageProvider(ICurrentUserService currentUserService) : IStorageProvider
    {
