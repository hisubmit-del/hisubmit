...
using ClientComponents.Pages.Public.Festivals.Components;
using ClientComponents.Shared.Dialogs;
using Microsoft.JSInterop;
using Timer = System.Timers.Timer;

namespace ClientComponents.Pages.Public.Festivals;
...
public partial class Home
{
   ...
   private bool _isPrerendering = RuntimeInformation.ProcessArchitecture != Architecture.Wasm;
