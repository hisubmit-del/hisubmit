...
namespace HiSubmit.Web.Components.Shared;
...
public partial class NavMenu
{
    ...
    private async Task OnChangeNSelectedAccount(object sender, int? festivalId)
    {
        ...
        {
            SelectedFestivalId=await _localStorage
                .GetItemAsync<int?>(StorageConstants.Local.AdminSelectedFestivalId);
        }
        else
        {
            SelectedFestivalId = await _localStorage
    ...
    private async Task<bool> AdminSelectFestival()
    {
        ...
        f = await _localStorage.ContainKeyAsync(StorageConstants.Local.AdminSelectedFestivalId);
