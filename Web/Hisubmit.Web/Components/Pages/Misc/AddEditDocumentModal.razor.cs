...
using HiSubmit.Client.Infrastructure.Managers.Misc.Document;
using HiSubmit.Client.Infrastructure.Managers.Misc.DocumentType;
...
namespace HiSubmit.Web.Components.Pages.Misc
{
    public partial class AddEditDocumentModal
    {
        ...
        private async Task<IEnumerable<int>> SearchDocumentTypes(string value,CancellationToken token)
        {
