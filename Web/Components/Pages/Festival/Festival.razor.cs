...
public partial class Festival : IDisposable
{
    ...
    private FestivalFilesAndMedia _festivalFilesAndMedia;
    ...
    private string GetStepHint() => _activePanelIndex switch
    {
        ...
        4 => Localize["Upload supporting files, the public cover and gallery images before release."],
        5 => Localize["Review automation and additional settings before release."],
