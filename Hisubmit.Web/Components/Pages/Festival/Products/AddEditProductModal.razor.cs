...
namespace HiSubmit.Web.Components.Pages.Festival.Products;
...
public partial class AddEditProductModal
{
    ...
    private List<GetAllArtCategoryResponse> _brands = new();
    ...
    {
        _processing = true;
        AddEditProductModel.FestivalId = FestivalId;
    ...
    {
        var data = await ProductManager.GetProductImageAsync(AddEditProductModel.Id,FestivalId);
        if (data.Succeeded)
        {
